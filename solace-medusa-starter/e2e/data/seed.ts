...
// axios.defaults.baseURL = 'https://shattering-silly-scam.medusajs.app' || 'http://localhost:9000'
...
//   }
// }
// let mail = "test1@example.com"
// mail = mail.replace(/\d+/g, (match) => (parseInt(match) + 1).toString());

// export async function seedUser(email?: string, password?: string) {
//   const user = {
//     // first_name: 'Test',
//     // last_name: 'User',
//     email: email || 'marcin.kaczmarczyk+680@rigbyjs.com',
//     password: password || 'supersecret',
//   }
//   try {
//     await axios.post('/auth/customer/emailpass/register', {
//       email: mail,
//       password: "zaq1@WSX",
//     }, {
//       headers: {
